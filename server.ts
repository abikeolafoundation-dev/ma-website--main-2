    ...
    const posts = [
      {
        ...
        platform: 'youtube',
        type: 'combined',
        content: 'Our latest documentary on the Sustainable Endowment Model is now live. See how we are building sustainable futures.',
      ...
      },
      {
        ...
        platform: 'twitter',
        type: 'text',
        content: 'Today we reached a milestone of 50 scholarships awarded to orphans in the North-East region. Thank you to our donors for making this possible. #EducationForAll #AbikeolaFoundation',
      ...
      },
      {
        ...
        platform: 'linkedin',
        type: 'combined',
        content: 'We are pleased to announce our strategic partnership with international non-profit coalitions to standardize our transparency reporting protocols. Professionalism in charity is not an option, but a duty.',
